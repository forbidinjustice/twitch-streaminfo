...
setTimeout(() => {
    addTip({
        ...
        name: "DBKynd",
        amount: "5.000000000",
        message: "Test Message!!!! anneBurger",
        email: "db@dbkynd.com"
    });
}, 2000);
...
function addTip(data) {
    ...
    $('.columns .tips ul').prepend("<li><div class='time'>" + time + "</div><span class='username'>" + data.name +
        "</span> <span class='amount'>($" + usd + ")</span><div class='message'>" + data.message +
...
function addSub(data) {
    ...
    $('.columns .subs ul').prepend("<li><div class='time'>" + time + "</div><span class='username'>" + data.username +
        "</span> <span class='amount'>" + months + "</span><div class='message'>" + message + "</div></li>");
...
function addCheer(data) {
    ...
    $('.columns .cheers ul').prepend("<li><div class='time'>" + time + "</div><span class='username'>" + data.username +
        "</span> <span class='amount tie_" + getBitTier(data.bits) + "'>(" + data.bits + ")</span><div class='message'>" +
        message + "</div></li>");
